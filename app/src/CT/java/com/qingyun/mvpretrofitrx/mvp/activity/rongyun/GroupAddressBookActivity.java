...
public class GroupAddressBookActivity extends BaseActivity<ChatContact.View, ChatContact.Presenter> implements ChatContact.View {
    @BindView(R.id.rcy)
    RecyclerView rcy;
    GroupAddressBookAdapter groupAddressBookAdapter;
    ...
    public void init() {
        ...
        list = new ArrayList<>();
        groupAddressBookAdapter = new GroupAddressBookAdapter(getContext(),list);
        ...
        rcy.setAdapter(groupAddressBookAdapter);
    }
