...
public class IndicatorSeekBar extends View {
    ...
    private int mScale = 2;//the scale of the float progress.
    ...
    public void setmProgressTrackColor(int mProgressTrackColor) {
        this.mProgressTrackColor = mProgressTrackColor;
        invalidate();
    }
    ...
    public boolean ismIsFloatProgress() {
        return mIsFloatProgress;
    }

    public void setmIsFloatProgress(boolean mIsFloatProgress) {
        this.mIsFloatProgress = mIsFloatProgress;
    }
