...
import com.lzj.gallery.library.adapter.AssetsViewPagerAdapter;
import com.lzj.gallery.library.adapter.BannerFragmentPagerAdapter;
...
public class BannerViewPager extends RelativeLayout implements View.OnTouchListener,ViewPager.OnPageChangeListener{
    ...
    private List<Fragment> mList;//url数组
...
//    };
     ...
     */
    public BannerViewPager initBanner(List<Fragment> list,boolean isGallery,FragmentManager fragmentManager){
        mList=list;
        //引入布局
        ...
        mPagerAdapter = new BannerPagerAdapter(mList,mContext,fragmentManager);
        ...
        mViewPager.setOffscreenPageLimit(10);//设置预加载的数量，这里设置了2,会预加载中心item左边两个Item和右边两个Item
